...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 1)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 2)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 3)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 4)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 5)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 6)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 7)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 8)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 9)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 10)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 11)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 12)}
...
\begin{table}[htbp]
\begin{center}
\caption{Nuclides Calculated via Interpolation (Cont. 13)}
