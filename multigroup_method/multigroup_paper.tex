...
\end{equation}
where $\lambda_i^{\mbox{eff}}$ is the effective decay-constant for the $i$\superscript{th} nuclide at time $t$ (equation \ref{effective_decay}), 
and $b_{jit}^{\mbox{eff}}$ is the effective branch ratio from nuclide $j$ to nuclide $i$ at time $t$ (equation \ref{effective_branch}). 
\begin{equation}
