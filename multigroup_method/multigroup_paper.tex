...
solve fundamental physical systems, dominant physics codes parameterize the system and use interpolations
...
flux spectrum as a function of burn time.  Because the flux is not constant, parameterization in 
terms of fluence is no longer an optimal choice.  Here instead, the reactor library contains 
cross section data as a function of burn time under a constant power irradiation.  The reactor model 
...
are calculated.  In addition, the flux spectrum is also solved for.
...
concludes this study with current limitations of the method and presents opportunities for
future work.
