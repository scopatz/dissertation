...
The purpose of this new multiple energy group reactor model, like with the one-group model, is to 
...
displays the perturbations when the fuel density has two reference values, the initial \nuc{U}{235} mass 
...
Because neutron transport is not performed here, the direction of neutron travel is not
...
However, the space that the parameters exist in is at least 10-dimensional, as defined by Table \ref{char_perturbable_variables}.  
