...
those of the unit cell.  Reflecting boundary conditions are applied to the lattice where required.
...
Basic errors are sufficiently captured by the tests above, 
...
section as $\Sigma_{f,\mbox{fuel},t}$ [cm\superscript{-1}].
\begin{equation}
