...
Moreover, the static perturbation table as formulated is a static construct.  Simple cahnges to the table
require a complete re-computation of the outer product of all parameters.
