...
Using essential physics models at multiple scales,
...
The fuel cycle cost (FCC) is the cost to buy the fresh fuel to be loaded into
...
summarized briefly here.  The FCC\subscript{t}
...
LWR system.  Enriched uranium (4.9\% \nuc{U}{235}) is burned in an LWR to 60
...
in the OECD study, the uranium was enriched to 4.2\% \nuc{U}{235} and burned in
the LWR to 50 MWd/kgIHM.

\begin{table}[htbp]
\begin{center}
\caption{Nuclide Composition [kg\subscript{i}/kgIHM] of LWR TRU feed to FR after 6 years of Cooling}
\label{ses_table4}
\begin{tabular}{|l|c|c|}
\hline
...
OECD NEA report \cite{OECD2002}.  This report recommends 210,000 \$/m\superscript{3} and 400,000
\$/m\superscript{3} for the disposal charges of UF and HLW respectively. After
conditioning, 1 tIHM UF will result in 2 m\superscript{3} waste, or 420 \$/kgIHM.
For vitrified HLW, a canister of volume 0.18 m\superscript{3} is taken to contain 47.6
...
fractions as plotted in Figure \ref{ses_fig06}.  TRU\subscript{out} is the TRU 
...
Figure \ref{ses_fig10} shows the mass of LWR UF needed to fabricate 1 kg of FR fresh fuel
as a function of cycle number for the 99.9\% separation
efficiency case.  For cycle numbers greater than 2, actinides from LWR fuel
