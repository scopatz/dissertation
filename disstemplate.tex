...
for making me a better scientist and engineer.  To Kathryn Huff, words fail.
...
\include{one_group_method/one_group_paper}

\include{se_sensitivity/se_sensitivity_paper}

\include{ct_sensitivity/ct_sensitivity_paper}

\include{multigroup_method/multigroup_paper}
...
\include{multigroup_method/appendix_serpent_input}

\include{multigroup_method/appendix_integrate_solid_angle}

\include{multigroup_method/appendix_rmg_nuclide_lists}
...
\begin{vita}
Anthony Michael Scopatz was born in Three Rivers, California on 18
August 1984, the child of Jana \& Stephen Scopatz.  Anthony's childhood was spent
