...
\begin{itemize}
    ...
    \FromSlide{3}
        \item For important species for which high-fidelity continuous cross
            section data is not avialable, physical models and/or a flux weighted
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item First, there is as a nearest-neighbor calculation from the given
            reactor state to the pertubations states in the library.
...
%   1. Modified version of method_diagrm.tex put in figs/ (added document info)
...
\FromSlide{1}
\begin{itemize}
    \item Using the shorthand $a_p^*$ as a substitue for $a_{p^*}$, 
...
\FromSlide{1}
\begin{itemize}
    \item Fuel Cycle / Perfomance Assesment Simulator (GUI).
