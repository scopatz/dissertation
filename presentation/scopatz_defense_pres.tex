...
%	NAME="Scopatz_Physor_2010_Pres" && latex ${NAME}.tex && dvipdf ${NAME}.dvi
...
\title{Nuclear Fuel Cycle Sensitivity to the Variation of Physical Parameters}
\subtitle{May 12\superscript{th}, 2010 - PHYSOR - Pittsburgh, PA}
...
\slideCaption{Scopatz, \emph{et al.} - Physor 2010}
...
\FromSlide{2}
    \begin{center}
    \includegraphics[scale=0.5]{figs/base-case.eps}
    \end{center}
