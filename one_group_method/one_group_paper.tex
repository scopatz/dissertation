...
and destruction rates, and transmutation rates \nuc{H}{1} as a function of fluence.  For instance, the effective 
...
However, LWR SNF also has non-negligible amounts of \nuc{U}{236} bred into it, between 0.3-0.5\%.  
...
Figure \ref{1g_fig21} shows the mass in kilograms of LWR SNF that is required to generate 
