...
\label{1g_fig09}
\begin{center}
\includegraphics[scale=0.40]{one_group_method/figs/Fig09.eps}
\end{center}
\end{figure}
...
same and thus identical LWR UF is always used to top up the fast reactor.  
...
actinide mass into fission products over the course of their burn and considerable top-up of DU 
and LWR-TRU streams will be required.  
...
Figure \ref{1g_fig19} plots the fraction of the uranium and transuranics relative to 
...
There are various ways to define the conversion ratio of a reactor.  One of these is displayed in Figure 
\ref{1g_fig20}.  Specifically, this is known as the transuranic conversion ratio (TruCR).  
This is defined as one minus the change in the mass of TRU in the fast reactor core divided by the 
...
is made entirely of DU and recycled LWR fuel whereas other cycles use LWR UF only as top up.  
...
input concentrations [kg\subscript{$i$}/kgIHM] of selected actinides in the fresh fuel.  The output values are 
after burning and cooling, as with the figures above.  Data is shown here for three fuel cycle 
pass numbers: 1, 3, and 10.  Once again, it is demonstrated that convergence to equilibrium must be explicitly 
