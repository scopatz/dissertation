...
\end{equation}
Here, $t_C$ [years] is the time that the UF spends in storage cooling,  $m_i(t_C)$ [kg] is the 
mass of the $i$\superscript{th} daughter of the parent species with mass $m_1$ [kg]. The $\lambda$s [1/years] 
...
is made entirely of recycled LWR fuel whereas other cycles use LWR UF only as top up.  
